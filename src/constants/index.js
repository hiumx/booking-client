...
export const LIST_ITEMS_SUB_FOOTER
    = ["About Booking.com", "Customer Service help", "Terms & Conditions", "Privacy & Cookie Statement"];

export const LIST_CAROUSEL_IMAGE_FAKE = [
...
export const LIST_VIET_NAM_TRAVEL_FAKE = [
    {
...
export const LIST_DATA_SIMPLE_COMPONENT_FAKE = [
    {
